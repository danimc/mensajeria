                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="input-group mb-3 col-sm-6">
                                            ...
                                            <input class="form-control form-control-solid disabled" min="<?php echo $consecutivo ?>" max="9999" id="oficio" value="<?php echo $consecutivo ?>" name="oficio" type="number" placeholder="">
                                ...
                                <div class="col-sm-12 form-group">
                                    <div class="row">
                                        ...
                                        <select class="form-control form-control col-md-5 text-bold" name="tipo" id="tipo">
                                ...
                                <div class="col-sm-12 form-group">
                                    <div class="row">
                                        ...
                                        <select required name="dependencia" id="dependencia" class="form-control select2_demo_1 col-sm-9" onchange="obt_responsable(this.value)">
                                ...
                                <div class="col-sm-12 form-group">
                                    <div class="row">
                                        ...
                                        <input required type="text" class="form-control form-control col-md-9 text-bold" name="destinatario" id="destinatario">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 form-group">
                                    <div class="row">
                                        ...
                                        <input required type="text" class="form-control col-sm-9  " name="cargo" id="cargo">
                                    </div>
                                </div>
                                <div class="col-sm-12 form-group">
                                    <div class="row">
                                        <label class=" col-form-label col-sm-2">Asunto:</label>
                                        <textarea required class="form-control  col-sm-9" name="asunto" id="asunto"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12 form-group">
                                    <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <select name="ccp[]" id="ccp" class="form-control select2_demo_1 col-sm-9" multiple="true">
