                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 form-group">
                                    <div class="row">
                                        ...
                                        <select required name="dependencia" id="dependencia"
                                            class="form-control-solid select2_demo_1 col-sm-9"
                                ...
                                <div class="col-sm-12 form-group">
                                    <div class="row">
                                        ...
                                        <input required type="text"
                                            class="form-control form-control-solid col-md-9 text-bold"
                                ...
                                <div class="col-sm-12 form-group">
                                    <div class="row">
                                        ...
                                        <input required type="text" class="form-control col-sm-9 form-control-solid "
                                            name="cargo" id="cargo">
                                    </div>
                                </div>
                                <div class="col-sm-12 form-group">
                                    <div class="row">
                                        ...
                                        <textarea required class="form-control form-control-solid col-sm-9"
                                            name="asunto" id="asunto"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12 form-group">
                                    <div class="row">
                                        <label class=" col-form-label col-sm-2">Exp.:</label>
                                        <input type="text" class="form-control col-sm-7 form-control-solid " name="exp"
                                            id="exp">
                                    </div>
                                </div>
