                ...
                <a href="<?php echo base_url()?>index.php?/mensajeria/nueva_copia">
                    <div class="card btn-primary">
                        <div class="card-body">
                            ...
                            <div class="text-white mt-1"><i class="ti-stats-up mr-1"></i><small>Registre un Oficio a
                                    mandar</small></div>
                        </div>
                        <div class="progress mb-2 widget-dark-progress">
                            <div class="progress-bar" role="progressbar" style="width:100%; height:5px;"
                ...
                <a href="<?php echo base_url()?>index.php?/mensajeria/lista_mensajes">
                    <div class="card btn-info">
                        <div class="card-body">
                            ...
                            <div class="text-white mt-1"><i class="ti-stats-up mr-1"></i><small>ver los oficios
                                    mandados</small></div>
                        </div>
                        <div class="progress mb-2 widget-dark-progress">
                            <div class="progress-bar" role="progressbar" style="width:100%; height:5px;"
                ...
                <div class="ibox ibox-fullheight">
                    ...
                    <div class="ibox-body">
                        <ul class="timeline scroller" data-height="470px">              
                            ...
                            <li class="timeline-item" id="elemento" data-toggle="tooltip"
